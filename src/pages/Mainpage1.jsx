...
export default function Mainpage1() {
  ...
  return (
    <>
      <div className="bg-white border-2 min-h-screen flex flex-col items-center">
        <div className="mt-5 text-lg">금연한지 00시간 지났습니다~!</div>
        <div className="flex">
          <div className="w-[1px] h-[1000px] border-2 border-black"></div>
          <div className="flex flex-col items-center mt-5 space-y-5">
            {boxData.map((box, index) => (
              <div
                key={index}
                className="box border w-[300px] bg-[#F5F2EB] rounded-xl p-4 flex flex-col ml-[160px]">
