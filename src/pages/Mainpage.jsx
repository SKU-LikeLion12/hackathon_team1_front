    ...
    <div className="bg-[#F5F2EB] min-h-screen flex items-center justify-center">
      <div className="flex flex-col space-y-4">
        <div className="box border-2  rounded-3xl w-[370px] h-[270px] bg-white">
          ...
          <div className="box2 border w-[250px] h-[80px] mt-[30px] ml-[60px] bg-[#F5F2EB] rounded-xl p-2 ml-[105px]">
            <div className="font-bold ml-3 text-[15px]">20분</div>
            <div className="ml-3 text-[9px]">심박수가 정상으로 돌아옵니다</div>
            <ProgressBar progress={30} /> {/* Adjust the progress as needed */}
          </div>
          <div className="box3 border w-[250px] h-[80px] mt-[20px] ml-[60px] bg-[#F5F2EB] rounded-xl p-2 ml-[105px]">
            <div className="font-bold ml-3">8시간</div>
            <div className="ml-3 text-[9px]">진정하세요</div>
            <ProgressBar progress={40} /> {/* Adjust the progress as needed */}
          </div>
        </div>
