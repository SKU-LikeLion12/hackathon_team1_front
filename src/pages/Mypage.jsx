    ...
    <>
      ...
      <div className='p-5'>
        ...
        <div className='flex flex-col items-center mx-auto mt-4'>
          ...
          <label htmlFor="file-upload" className='text-sky-600 text-sm mt-2 cursor-pointer'>
            사진수정
          </label>
          <input 
            id="file-upload" 
        ...
        <div className='grid grid-rows-8 grid-cols-1'>
          <div className='flex justify-between mt-5 ml-5 mb-5'>
            <div>이름</div>
            <input type='text' className='mr-5 border-2 border-t-0 border-r-0 border-l-0 text-center'/>
          </div>

          <div className='flex justify-between mt-5 ml-5 mb-5'>
            <div>금연 시작 일시</div>
            <div>
              <input type='date' className='mr-5 border-2 border-t-0 border-r-0 border-l-0 text-center w-[176px]' />
            </div>
          </div>
