...
export default function AmountModal(props) {
  const { AmountModalClose } = props;

  const amountToSave = [
    { period: "1주", price: "30,000원" },
    { period: "1개월", price: "130,000원" },
    { period: "1년", price: "1,600,000원" },
    { period: "5년", price: "8,000,000원" },
    { period: "10년", price: "16,000,000원" },
    { period: "20년", price: "32,000,000원" },
  ];
            ...
            <div className="w-full min-h-[530px] bg-white rounded-2xl drop-shadow-xl">
              <div className="w-[80%] min-h-[530px] mx-auto py-10 text-center flex flex-col justify-center items-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">56000원</p>
                </div>
